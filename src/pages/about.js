...
import profilePic from '../../public/images/profile/AKC.jpg';
...
const about = () => {
    return (
        <>
            <Head>
                <title>Arun Chourasia | About Page</title>
                ...
                <Layout className='pt-16'>
                    ...
                    <div className='grid w-full grid-cols-8 gap-16 sm:gap-8'>
                        ...
                        dark:bg-dark dark:border-light xl:col-span-4 md:order-1 md:col-span-8'>
                            ...
                            <Image src={profilePic} alt="Arun Chourasia" className='w-full h-auto rounded-2xl' 
                             priority
